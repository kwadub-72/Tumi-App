...
-- Restore the required GoTrue instance record (wiped by TRUNCATE ... CASCADE above)
...
-- Create auth users
-- NOTE: GoTrue's Go scanner requires empty strings (not NULL) for all token/change columns.
...
-- Create profiles
INSERT INTO public.profiles (id, handle, name, avatar_url, status, activity, activity_icon, height, weight_lbs, body_fat_pct, macro_targets, training_target, is_private) VALUES
('00000000-0000-0000-0000-000000000001', '@kwadub', 'Kwaku Adubofour', 'https://i.pravatar.cc/150?u=kwadub', 'natural', 'Bodybuilder (Cut)', 'hammer', '6''3', 203, '8%', '{"p": 250, "c": 200, "f": 60, "calories": 2380}'::jsonb, 'Lean is law.', false),
('00000000-0000-0000-0000-000000000002', '@jsmith', 'Jordan Smith', 'https://i.pravatar.cc/150?u=1', 'natural', 'Powerlifting', 'weight-lifter', '5''11', 215, '12%', '{"p": 220, "c": 380, "f": 80, "calories": 3160}'::jsonb, 'Total world domination.', false),
('00000000-0000-0000-0000-000000000003', '@arivera', 'Alex Rivera', 'https://i.pravatar.cc/150?u=2', 'enhanced', 'Bodybuilder (Bulk)', 'hammer', '6''1', 230, '10%', '{"p": 280, "c": 450, "f": 100, "calories": 3820}'::jsonb, 'Size over everything.', true),
('00000000-0000-0000-0000-000000000004', '@cjones', 'Casey Jones', 'https://i.pravatar.cc/150?u=3', 'natural', 'Hybrid Athlete', 'infinity', '5''9', 178, '9%', '{"p": 195, "c": 310, "f": 70, "calories": 2690}'::jsonb, 'Strong AND fast.', true),
('00000000-0000-0000-0000-000000000005', '@rcooper', 'Riley Cooper', 'https://i.pravatar.cc/150?u=4', 'none', 'Distance Runner', 'run-fast', '5''7', 148, '7%', '{"p": 160, "c": 420, "f": 55, "calories": 2855}'::jsonb, 'Sub-3 marathon.', false),
('00000000-0000-0000-0000-000000000006', '@qtaylor', 'Quinn Taylor', 'https://i.pravatar.cc/150?u=5', 'natural', 'Bodybuilder (Cut)', 'hammer', '5''10', 185, '10%', '{"p": 225, "c": 180, "f": 55, "calories": 2155}'::jsonb, 'Stage ready.', false),
('00000000-0000-0000-0000-000000000007', '@mbailey', 'Morgan Bailey', 'https://i.pravatar.cc/150?u=6', 'natural', 'Glute Growth', 'cake-variant', '5''6', 145, '18%', '{"p": 165, "c": 280, "f": 65, "calories": 2405}'::jsonb, 'Built, not small.', true),
