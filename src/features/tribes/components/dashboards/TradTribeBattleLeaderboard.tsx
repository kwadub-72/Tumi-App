...
const generateDummyLeaderboard = () => [
    ...
    { id: '2', rank: 2, name: 'Michael', handle: '@Michael123456', avatar: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Flag_of_Ghana.svg/1200px-Flag_of_Ghana.svg.png', logged: false, trend: 5, trendDir: 'up', record: '7-1', leaf: true, activity: 'hammer' },
