...
// Initial consumed stats (Mocked for now)
const INITIAL_STATS = {
    p_consumed: 100,
    p_goal: 200,
    c_consumed: 100,
...
export default function MealEntryScreen() {
    ...
    const amountInOz = NutritionService.convertToOz(amountValue, unit);
    const { cals: proposedCals, macros: proposedMacros } = NutritionService.calculateMacros(amountInOz);
            ...
            <View style={styles.macroSliderRow}>
                ...
                <View style={styles.sliderContainer}>
                    <View style={styles.sliderTrack}>
                        ...
                        {/* Overflow Warning */}
                        {isOverflowing && (
                            <View style={[styles.sliderSegment, { width: `${overflowWidth}%`, backgroundColor: Colors.error }]}>
                ...
                <View style={styles.modalOverlay}>
                    ...
                    <View style={styles.pickerContainer}>
                        ...
                        {UNITS.map(u => (
                            ...
                            >
                                <Text style={[styles.unitText, unit === u && { color: Colors.primary }]}>{u}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                </View>
